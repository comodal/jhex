...
final class GuavaTests {
  ...
  @Test
  void testBase16InvalidDecodingNewlines() {
  ...
  @Test
  void testBase16InvalidDecodingG() {
  ...
  @Test
  void testBase16ValidDecodingOddLength1() {
  ...
  @Test
  void testBase16ValidDecodingOddLength3() {
  ...
  @Test
  void testBase16InvalidDecodingOddLength1() {
    assertEquals("Invalid hex encoding length of 1.",
        assertThrows(IllegalArgumentException.class,
